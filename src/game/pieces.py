...
def get_cells(piece: str, rotation: int) -> list[tuple[int, int]]:
    """
    Returns relative cell coordinates for a piece at the specified rotation state.
    """
...
def get_colour(piece: str) -> tuple[int, int, int]:
    """
    Returns the RGB colour tuple for a piece.
    """
...
def get_spawn(piece: str) -> tuple[int, int]:
    """
    Returns the initial spawn coordinates for a piece.
    """
