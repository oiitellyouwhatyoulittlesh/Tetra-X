...
class ResetData(Screen):
    ...
    def handle_events(self, events) -> None:
        """
        Handles keyboard and mouse input for resetting data options.
        """
        for event in events:
    ...
    def reset_data(self) -> None:
        """
        Resets all personal records to default values.
        """
        save_records(deepcopy(DEFAULT_RECORDS))
    ...
    def draw(self, renderer) -> None:
        """
        Draws the reset data confirmation interface.
        """
        ...
        # Title Text
        title = title_font.render("RESET ALL DATA?", True, normal_colour)
